...
class USC_Department_TaxonomyField extends AdminPageFramework_TaxonomyField {
     ...
     */
    public function sortable_columns_USC_Department_TaxonomyField( $aColumn ) {	// sortable_column_{instantiated class name}
     ...
     */
    public function cell_USC_Department_TaxonomyField( $sCellHTML, $sColumnSlug, $iTermID ) {	// cell_{instantiated class name}
    ...
    public function cell_USC_Department_TaxonomyField_custom( $sCellHTML, $iTermID ) {	// cell_{instantiated class name}_{cell slug}
     ...
     */
    public function do_USC_Department_TaxonomyField() {	/* ~ */ }
     ...
     */
    public function validation_USC_Department_TaxonomyField( $aNewOptions, $aOldOptions ) {
